...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('lodge_address', trans('quickadmin.district_lodges.fields.lodge_address').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('lodge_contact_number', trans('quickadmin.district_lodges.fields.lodge_contact_number').'*', ['class' => 'control-label']) !!}
