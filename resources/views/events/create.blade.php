        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::input('dateTime-local','event_start', old('event_start'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::input('dateTime-local','event_end', old('event_end'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
